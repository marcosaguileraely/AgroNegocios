...
public class XTuto2Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xtuto2);
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            try {
                ...
                if(e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                    Intent goToTuto3 =  new Intent(XTuto2Activity.this, XTuto3Activity.class);
                    startActivity(goToTuto3);
                }  else if (e2.getX() - e1.getX() > SWIPE_MIN_DISTANCE && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                    Intent goToTuto2 =  new Intent(XTuto2Activity.this, XTuto1Activity.class);
                    startActivity(goToTuto2);
                }
            } catch (Exception e) {
                // nothing
            }
